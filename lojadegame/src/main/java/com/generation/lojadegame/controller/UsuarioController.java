...
/*Mantenha a Atenção aos Detalhes, nos Métodos postUsuario e putUsuario para não 
 * esquecer a notação @Valid. Caso ela não seja inserida, ao fornecer parâmetros inválidos, 
 * o servidor retornará o HTTP Status 500, ao invés do HTTP Status 400.
 */

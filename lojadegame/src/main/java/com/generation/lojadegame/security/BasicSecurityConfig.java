 ...
 * 
 * @EnableWebSecurity: habilita a segurança de forma Global (toda a aplicação) 
 * e sobrescreve os Métodos que irão redefinir as regras de Segurança da sua aplicação.
 */
